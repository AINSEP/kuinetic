...
290 named effects across scroll reveals, hover/interaction, text, numbers, layout, SVG, 3D, and
...
- **Catalog** — all 290 named effects, grouped by category, with renderer and channel metadata.
