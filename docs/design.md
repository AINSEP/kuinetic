...
**Do not create one runtime chunk per name.** 260 named effects come from 32 primitive families — ship a compressed
...
That's why the catalog can carry 260 named effects from only 32 primitive families.
