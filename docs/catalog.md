...
**Counts:** **260** named effects, over **32 primitive families**. Note that 48 names come from a
...
| 32 | `motion-path` | css | x | travel along an arbitrary curve (`offset-path`) |
...
Renderer split: **~173 `css`** · ~12 `prep` · ~58 `js`.
