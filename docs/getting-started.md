...
252 named effects see the [Catalog](?doc=catalog); for why the library is built the way it is —
...
- **[Catalog](?doc=catalog)** — all 252 named effects, grouped by category, with renderer and
